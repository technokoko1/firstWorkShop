...
async function start() {
    ...
    app.route('/register')
        ...
        .trim()
            ...
            .isLength({ min: 3 }).withMessage('Username needs to be atleast 3 chars long'),
            ...
            body('repeatPassword').trim().custom((value,{req})=>{
                ...
                //proverqvame dali password e ravno na repeatPassword
            }).withMessage('Incorect repeat password'),
             registerPost)
